 ...
 toastTitle.textContent = title;
  ...
  document.getElementById("rsvpForm")?.addEventListener("submit", async (e) => {
    ...
    try {
      ...
      showToast("Resposta enviada.\n\n AVÍS: L'organització declina qualsevol responsabilitat per conseqüències físiques, mentals o existencials, incloent però no limitant-se a: ressaca severa, deshidratació, agulletes, pèrdua de veu, memòria selectiva o criteri dubtós 😈", "Perfecte!");
